        ...
        try {
            ...
            $query = "
                ...
                SELECT
                    ...
                    IFNULL(tis.total_item_discount_amount, 0),
                    IFNULL(tis.total_item_net_sales, 0),
                ...
                LEFT JOIN (
                    SELECT
                        ...
                        id.branch_name,
                        id.store_name,
                        SUM(id.discount_amount) AS total_item_discount_amount,
                        GROUP_CONCAT(DISTINCT id.discount_code ORDER BY id.discount_code SEPARATOR ', ') AS applied_discount_codes,
                        SUM(id.net_total) AS total_item_net_sales
                    FROM
                        item_details AS id
                    WHERE
                        id.void_flag = 0
                ...
                LEFT JOIN (
                    SELECT
                        ...
                        pd.branch_name,
                        pd.store_name,
                        GROUP_CONCAT(DISTINCT pd.payment_type ORDER BY pd.payment_type SEPARATOR ', ') AS combined_payment_types
                    FROM
